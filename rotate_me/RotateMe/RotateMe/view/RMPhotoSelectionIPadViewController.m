...
- (void) refreshPhotos
{
    [RMPhotoSelectionIPadViewController setLastScroll:self.scrollView.contentOffset.x];
...
- (void) printPhotos
{
    ...
    [self.scrollView setContentOffset:CGPointMake([RMPhotoSelectionIPadViewController getLastScroll], 0.0)];
...
{
    RMInGameIPadViewController* inGameView = [segue destinationViewController];
