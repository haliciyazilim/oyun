...
- (id) init {
    if (self = [super init]) {
        ...
        [menuItem1 setFrame:CGRectMake(432.0, 270.0, 163.0, 57.0)];
        ...
        [menuItem2 setFrame:CGRectMake(432.0, 327.0, 163.0, 57.0)];
        ...
        [menuItem3 setFrame:CGRectMake(432.0, 384.0, 163.0, 57.0)];
